...
public class FontOptionProvider {
    ...
    private void loadOptions() {
        ...
        for (String overlayPackage : mOverlayPackages) {
            try {
                ...
                mOptions.add(new FontOption(overlayPackage, label, headlineFont, bodyFont, (mActiveOverlay != null && mActiveOverlay.equals(overlayPackage))));
    ...
    private void addDefault() {
        ...
        mOptions.add(new FontOption(null, mContext.getString(R.string.default_theme_title),
                headlineFont, bodyFont, mActiveOverlay == null));
    }
